...
issues = [
    ...
    {
        "type": "docs",
        "file": "src/case_workflow/workflow_engine.py",
        "what": "docstring to get_dashboard method",
    ...
    {
        "type": "refactor",
        "file": "src/knowledge_os/knowledge_engine.py",
        "what": "return type annotation to KnowledgeEngine.__init__",
    ...
    {
        "type": "refactor",
        "file": "src/case_workflow/service.py",
        "what": "return type annotation to CaseWorkflowService.__init__",
    ...
    {
        "type": "refactor",
        "file": "src/exposure_management/service.py",
        "what": "return type annotation to ExposureService.__init__",
    ...
    },
    {
        ...
        "what": "return type annotation and docstring to _utcnow helper",
    ...
    {
        "type": "refactor",
        "file": "src/data_pipeline/data_sources.py",
        "what": "return type annotation and docstring to discover_schema",
    ...
    {
        "type": "docs",
        "file": "src/alert_correlation/correlation_engine.py",
        "what": "docstring to get_dashboard in AlertCorrelationEngine",
    ...
    },
    {
        ...
        "what": "return type annotation to MLExplainerService.__init__",
    ...
    },
    {
        ...
        "what": "return type annotation to ReportingService.__init__",
...
for i, issue in enumerate(issues):
    ...
    url = "https://api.github.com/repos/tmdeveloper007/AegisGraph-Sentinel-2.0/issues"
...
print("ISSUE_NUMS:", json.dumps([x[0] for x in created_issues if x[0]]))
